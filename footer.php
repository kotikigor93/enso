<footer>
    <div class="container">
        <div class="footer-nav footer-desc">
            ...
            <div class="footer-nav_block">
                ...
                <ul>
                    ...
                    <li>GOOGLE ADVERTISMENT</li>
                    <li>SEARCH ENGINE OPTIMIZATION</li>
                    <li>REVITALIZE OUTDATED DESIGNS</li>
                    <li>USABILITY AUDIT & OPTIMIZATION</li>
                </ul>
            </div>
            <div class="footer-nav_block">
                <h3>- QUICK LINKS</h3>
        ...
        <div class="corp">
            <p>
                Copyright © <?php echo date('Y') ?> ENSO Tech Solunion. All Rights Reserved
            </p>
            <p>
